...
import dreamerv3.nets.world_model as worldmodel
...
class Agent(nj.Module):
  ...
  def __init__(self, obs_space, act_space, config):
    ...
    self.wm = {
        'base': worldmodel.WorldModel,
        'thick': thick.ThickWorldModel
    }[config.wm.typ](obs_space, act_space, config, name='wm')
    ...
    self.modules = [self.wm, self.ac.actor, self.ac.critic]
